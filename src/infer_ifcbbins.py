...
try:
    ...
    from datasets import IfcbBinDataset, IfcbBinImageTransformer, MyDataLoader
...
def argparse_init(parser=None):
    if parser is None:
        parser = argparse.ArgumentParser(
            description="Perform onnx-model inference on ifcb bins, without torch"
        )
